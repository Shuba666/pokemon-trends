  ...
  return (
    <div id="app-root" style={{ height: '100vh', display: 'flex', flexDirection: 'column', background: '#0f172a', color: '#f1f5f9', fontFamily: "'Segoe UI', sans-serif", overflow: 'hidden' }}>
      ...
      <header style={{ background: 'linear-gradient(135deg, #dc2626, #b91c1c)', padding: '0 20px', flexShrink: 0, boxShadow: '0 2px 20px rgba(220,38,38,0.4)' }}>
        <div id="header-row" style={{ height: 50, display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, position: 'relative' }}>
          <h1 style={{ fontSize: 16, fontWeight: 900, letterSpacing: '0.08em', whiteSpace: 'nowrap', flex: '0 0 auto' }}>⚡ POKEMON TRENDS OS</h1>

          {dates.length > 0 && (
            <div id="header-slider" style={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)', width: 380 }}>
